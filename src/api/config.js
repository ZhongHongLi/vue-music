...
export const topList = '/toplist/detail' // 获取所有榜单内容摘要
export const idxList = '/top/list' // 获取排行榜
export const hotSearchList = '/search/hot/detail' // 热搜列表
export const defaultSearch = '/search/default' //文本框默认搜索关键字
export const suggestSearch = '/search/suggest' // 搜索建议
...
export const newmvs = "/mv/first"  //最新mv
export const commentPlaylist = '/comment/playlist' // 获取歌单的评论
export const allMv = '/mv/detail' //获取mv数据
...
export const likelist='/likelist' //获取用户喜欢的歌曲列表
export const loginStatus = '/login/status' // 登录状态
export const recommenday='/recommend/resource' //每日推荐歌单
export const recommedsong='/recommend/songs' //获取每日推荐
export const usersonglist='/user/playlist' //获取用户歌单
export const toplist ='/toplist' //获取所有的排行的音乐列表
export const getsongurl="/song/url" 
export const comment='/comment/like' //给评论点赞
export const songcomment='/comment/music' //歌曲的评论
