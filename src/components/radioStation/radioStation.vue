            ...
            tabdata: [
                {
                    id: 6,
                    text: "电台分类",
                    classnames: "iconfont icon-fenlei red",
                },
                {
                    id: 7,
                    text: "电台排行",
                    classnames: "iconfont icon-paihang font7  red",
                },
                {
                    id: 8,
                    text: "付费精品",
                    classnames: "iconfont icon-weibiaoti-- font7 red",
                },
                {
                    id: 9,
                    text: "主播学院",
                    classnames: "iconfont icon-shu font7 red",
                },
            ],
            radioRecomList: [],
        }
