<template>
    <div class="album_container" ref="topHeight" @scroll.native="srollList">
        <song-listpage
            ...
            :idxComId="idxComId"
            :commentCount="
                detailtoplist.commentCount
                    ? detailtoplist.commentCount
                    : detailtoplist.album
                    ? detailtoplist.album.info.commentCount
                    : 0
            "
            :shareCount="
                detailtoplist.shareCount
                    ? detailtoplist.shareCount
                    : detailtoplist.album
                    ? detailtoplist.album.info.shareCount
                    : 0
            "
        ></song-listpage>
        <song-list
            ...
            <div class="plypading">
                <div class="playtitle">
                    ...
                    <div class="right-info">
                        ...
                        <div
                            style="font-size:0.3rem;color:#fff;text-aligin:center"
                        >
                            {{ SongName }}
                        </div>
                    </div>
...
export default {
    ...
    methods: {
        ...
        backgo() {
            ...
            this.$store.commit("SET_SMALLAUDIO_STATUS", true)
            this.setFull(false)
        },
        //转为大播放器
        returnFull() {
