<template>
 ...
 <p class="index-icon"><svg t="1567819718363" class="icon" style="transform: translateY(40%)" viewBox="0 0 1024 1024"
        ...
        <!-- 下面的盒子 -->
        <div class="button-boxbtn">
          <button class="btn"  style="margin-bottom:10px" @click="phoneloding">手机号登陆</button>
          <button class="btn mp " style="margin-bottom:20px"  @click="experience">立即体验</button>
            
          <div class="icon-text">
             <span class="iconfont  icon-linedesign-17"></span>
  ...
  <van-radio name="1" shape="square"   checked-color="dd001b">单选框 1</van-radio>
</van-radio-group> -->
            <p class="checkbox"><input type="checkbox"  v-model="checkboxselect"  @change="changebox($event)"><span style="line-height:2"><span style="color:#ccc">同意</span><span style="color:#fff">《用户协议》《隐私政策》《儿童隐私政策》</span></span></p>
                 </div>
        </div>
 </div>
</template>
